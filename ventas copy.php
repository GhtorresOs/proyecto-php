...
// Consulta para saber todas las ventas por producto
$sql = "SELECT producto, COUNT(producto) AS cantidad_productos FROM ventas GROUP BY producto";
...
$sql_total = "SELECT producto, SUM(importe) AS total_ventas FROM ventas GROUP BY producto";
...
// Consulta para ver qué vendedor generó más ventas
$sql_vendedores = "SELECT vendedor, COUNT(*) AS cantidad_ventas FROM ventas GROUP BY vendedor ORDER BY cantidad_ventas DESC";
...
// Consulta para ver en qué año se generaron más ventas
$sql_years = "SELECT year, COUNT(*) AS producto_year FROM ventas GROUP BY year ORDER BY year ASC";
